...
- `PoapsClient.mintAsync`, `mintSync` and `emailReservation` will throw different errors for mint codes already used or expired, and a new error for mint codes not found. See [POAPs errors](./packages/poap-sdk/poaps/Errors).
